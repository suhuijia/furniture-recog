...
net, image_mean = classify_model.load_model()
        ...
        if not os.path.exists(img_path):
            ...
            try:
                ...
                if top_n is not None:
                    result = classify_model.furniture_classify(img_path, net, image_mean, top_n)
                else:
                    result = classify_model.furniture_classify(img_path, net, image_mean)
...
if __name__ == "__main__":
    ...
    application = tornado.web.Application([
        (r"/v1/furniture/classify/", MainHandler),
    ])
